...
3. **記憶の更新方法**
   ...
   - **プロジェクト記憶** 
     - **CLAUDE.md**: 規約、技術スタック、git慣習など横断的に重要な知識
     - **.claude/DOCUMENT_NAME.md**: 具体的なタスク、詳細な実装記録、エラー解決策
...
2. **プロジェクト記憶** 
   - **CLAUDE.md** (プロジェクトルート)
     ...
     - **内容**: 技術スタック、アーキテクチャ、git慣習、コーディング規約
     - **更新時**: 横断的に重要な知識のみ追記
   - **.claude/DOCUMENT_NAME.md** (プロジェクト内)
     - **保存方法**: 用途別にドキュメント作成（例: tasks.md, errors.md, decisions.md）
     - **内容**: 具体的なタスク履歴、詳細な実装記録、エラー解決策
     - **更新時**: 具体的な作業内容や詳細情報を追記
...
3. **問題解決・実装完了時** (REQUIRED)
   ...
   - プロジェクト記憶: 
     - CLAUDE.mdに横断的に重要な決定事項・規約を追記
     - .claude/内の適切なドキュメントに具体的な解決策・詳細を追記
